  ...
  var SECTIONS = [
    {
      ...
      body: 'A hand-curated directory of 677+ genuinely useful websites across 35 categories — plus 47 free browser-based tools. No sign-up, no clutter, no dead links (we check).'
    },
    {
      icon: 'search',
